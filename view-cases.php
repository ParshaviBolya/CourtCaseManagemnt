...
<table class="table">
  ...
  <?php foreach($cases as $case){?>
    <tr>
      <td><?php echo $case['fileId']?></td>
      <td><?php echo $case['type']?></td>
      <td><?php echo $case['lawyerName']?></td>
	  <td><?php echo $case['clientName']?></td>
	  <td><form action="./view-case.php" method="POST"><input type="hidden" name="caseId" value='<?php echo $case['id']?>' /><input type="submit" value="View Case"><form></td>
    </tr>
  <?php }?>
  </tbody>
</table>
