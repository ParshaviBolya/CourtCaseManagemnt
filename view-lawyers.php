...
<table class="table">
  ...
  <?php foreach($lawyers as $lawyer){?>
    <tr>
      ...
      <td><?php echo $lawyer['phoneNumber']?></td>
      <td><?php echo $lawyer['email']?></td>
	  <td><?php echo $lawyer['aadharNumber']?></td>
	  <td><?php echo $lawyer['license']?></td>
	  <td><form action="" method="POST"><input type="hidden" name="lawyerId" value="<?php echo $lawyer['id']?>"/><input type="submit"/ value="View Lawyer"><form></td>
    </tr>
  <?php }?>
  </tbody>
</table>
