...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
	...
	<form class="text-center border border-light col-md-8 ml-5">
			...
			<!-- Field Id -->
			<input type="text"  class="form-control mb-4" placeholder="File Id" id="fileId">
			<input type="text" class="form-control mb-4" placeholder="Type" id="type">
			<label for="sel1">Select Lawyer:</label>
			<select name="lawyerId" class="form-control" id="lawyerId">
			<?php
				...
				curl_setopt($ch, CURLOPT_URL, $url);
				$r = curl_exec($ch);
				$lawyers = json_decode($r, true);
				$lawyers = $lawyers['response'];
				foreach($lawyers as $lawyer){
					echo '<option value="'.$lawyer['id'].'">'.$lawyer['name'].'</option>';
				}
			?>
			</select>
				<label for="sel2">Select Client:</label>
			...
			<!-- Sign in button -->
			<input class="btn btn-info btn-block my-4 " type="submit">Add Case</input>
